  ...
  return (
    <div>
      <div className="grid md:grid-cols-2 gap-8 items-start mt-12">
        <div className="dark:bg-gray-800 rounded-lg p-6 space-y-8 shadow-md">
          <p className="text-gray-600 dark:text-gray-400">
            At{" "}
            <span className="font-bold text-primary-600 dark:text-primary-400">
              {siteConfig.name}
            </span>
            , we are dedicated to fostering peace, unity, and spirituality
            through the teachings of Shir Guru Ravidass Ji. We organise
            religious ceremonies and cultural events to spread his message of
            equality and compassion. Our Sabha serves as a platform for the
            community to come together, celebrate, and learn.
          </p>
          <p className="text-gray-600 dark:text-gray-400">
            ...
            or details about our events and activities. Together, let&apos;s
            promote peace, unity, and the teachings of Guru Ravidass Ji.
          </p>
        </div>
