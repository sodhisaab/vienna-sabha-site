          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">{siteConfig.phone}</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-gray-800 text-sm">7:00 AM - 5:00 PM</span>
            </div>
          </div>
        </div>
      </div>
      <div className="bg-gray-50 rounded-lg p-6 space-y-8 shadow-md">
        <p>
          At{" "}
          <span className="font-bold text-primary-600">{siteConfig.name}</span>,
